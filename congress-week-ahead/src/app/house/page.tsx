  ...
  const events: CongressEvent[] = (await db
    ...
    .where(
      and(
        ...
        eq(congressEvents.chamber, "House")
      )
    )
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600">
          Floor sessions, votes, hearings, and committee activity for the House
      ...
      <section className="mb-10">
        ...
        <EventList
          events={floorEvents}
          emptyMessage="No House floor activity posted for this week."
        />
      </section>
      ...
      <section>
        ...
        <EventList
          ...
          emptyMessage="No House committee hearings scheduled for this week."
        />
      </section>
    </div>
  );
